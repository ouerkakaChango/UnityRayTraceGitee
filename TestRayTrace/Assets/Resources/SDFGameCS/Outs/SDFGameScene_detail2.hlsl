...
lightColors[2] = float3(1, 1, 1) * GetPntlightAttenuation(minHit.P, float3(0.04, 8.15, -3.29));
lightDirs[3] = normalize(minHit.P - float3(3.357384, 8.15, 0));
lightColors[3] = float3(1, 1, 1) * GetPntlightAttenuation(minHit.P, float3(3.357384, 8.15, 0));
lightDirs[4] = normalize(minHit.P - float3(-3.83, 8.15, 0));
lightColors[4] = float3(1, 1, 1) * GetPntlightAttenuation(minHit.P, float3(-3.83, 8.15, 0));
