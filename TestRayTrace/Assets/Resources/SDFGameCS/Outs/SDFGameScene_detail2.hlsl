...
{
float3 lightDirs[6];
float3 dirLightColors[6];
lightDirs[0] = normalize(minHit.P - float3(-0.07, 8.15, 3.42));
dirLightColors[0] = float3(2, 2, 2) * PntLightAtten(minHit.P, float3(-0.07, 8.15, 3.42));
lightDirs[1] = normalize(minHit.P - float3(-1.713, 2.707, -2.17));
dirLightColors[1] = float3(1.5, 1.5, 1.5) * PntLightAtten(minHit.P, float3(-1.713, 2.707, -2.17));
lightDirs[2] = normalize(minHit.P - float3(-3.526, 2.707, -2.17));
dirLightColors[2] = float3(1.5, 1.5, 1.5) * PntLightAtten(minHit.P, float3(-3.526, 2.707, -2.17));
lightDirs[3] = normalize(minHit.P - float3(0.04, 8.15, -3.29));
dirLightColors[3] = float3(2, 2, 2) * PntLightAtten(minHit.P, float3(0.04, 8.15, -3.29));
lightDirs[4] = normalize(minHit.P - float3(3.357384, 8.15, 0));
dirLightColors[4] = float3(2, 2, 2) * PntLightAtten(minHit.P, float3(3.357384, 8.15, 0));
lightDirs[5] = normalize(minHit.P - float3(-3.83, 8.15, 0));
dirLightColors[5] = float3(2, 2, 2) * PntLightAtten(minHit.P, float3(-3.83, 8.15, 0));
