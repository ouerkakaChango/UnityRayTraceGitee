...
{
uv = BoxedUV(minHit.P, float3(-2.544292, -5.18, 20.315), float3(1.007443, 1.513819, 0.10769), float3(0, 0, 0));
return uv;
}
else if (inx == 6 )
{
...
if(inx == 5 )
{
BoxedTB(T,B,minHit.P, float3(-2.544292, -5.18, 20.315), float3(1.007443, 1.513819, 0.10769), float3(0, 0, 0));
return;
}
if(inx == 6 )
{
...
const static int lightType[12] = {1000, 1, 1002, 1003, 1, 1, 1009, 1010, 1, 1011, 1015, 0};
...
if (i == 2 && (minHit.obj == 2 || minHit.obj == 4 || minHit.obj == 5 || minHit.obj == 8 || minHit.obj == 12 || minHit.obj == 14 || minHit.obj == 15 || minHit.obj == 17))
{
...
if (i == 6 && (minHit.obj == 4 || minHit.obj == 6))
{
...
if (i == 10 && (minHit.obj == 4 || minHit.obj == 6))
{
...
{
re = min(re, 0 + SDFBox(p, float3(-2.544292, -5.18, 20.315), float3(1.007443, 1.513819, 0.10769), float3(0, 0, 0)));
}
else if (inx == 6 )
{
