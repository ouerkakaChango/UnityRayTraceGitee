...
if(inx == 0 )
{
re = min(re, 0 + SDFBox(p, float3(0.0, 0.0, 0.0), float3(10.0, 0.5, 10.0), float3(0.0, 0.0, 0.0)));
}
else if (inx == 1 )
{
re = min(re, 0 + SDFBox(p, float3(0.0, 2.0, -3.8), float3(0.7, 0.9, 0.0), float3(338.2, 71.4, 0.0)));
}
	//@@@
return re;
