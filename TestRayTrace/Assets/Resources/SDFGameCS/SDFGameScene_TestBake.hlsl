...
if(inx == 7 )
{
if (!IsInBBox(p, float3(-42.31, 3.45, -54.24), float3(-40.31, 5.45, -52.24)))
{
return SDFBox(p, float3(-41.31, 4.45, -53.24), float3(1, 1, 1)) + 0.1;
}
}
if(inx == 8||inx == 4||inx == 5||inx == 0||inx == 9||inx == 1)
{
