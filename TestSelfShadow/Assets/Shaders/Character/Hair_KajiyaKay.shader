Shader "DianDian/Hair_KajiyaKay"
{
    Properties
    {
        ...
        _SpecularShininess1("Specular Shininess 1", Range(2,800)) = 5
        _ShiftValue1("ShiftValue1", Range(-1.0,1.0)) = 0.0
        _SpecularColor1("SpecularColor1", Color) = (1,1,1,1)
        _SpecularShininess2("Specular Shininess 2", Range(2,800)) = 5
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "HairLightModel_KajiyaKay.cginc"
